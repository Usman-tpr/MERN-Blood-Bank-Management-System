...
const SignupAdmin = () => {
    ...
    const handleSignup = async (event) => {
        ...
        if (!name || !CNIC || !phone || !email || !password) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
            <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                <h2 className="text-3xl font-semibold text-center text-[#c3073f] mb-8">Administrator Signup</h2>
                ...
                <div className="mt-4 flex justify-between">
                    ...
                    {status && (
                        <button
                            onClick={handleNext}
                            className="text-[#c3073f] bg-gray-200 w-full"
                        >
                            Login
                        </button>
                    )}
